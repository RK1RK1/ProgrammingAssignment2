...
##MakeCachematrix initializes a matrix x and a cached inverse matrix inv. 
##The set function updates the matrix x and clears the cached inverse, inv. 
##The get function retrieves the matrix, 
##the setinverse and getinverse functions store and retrieve the cached inverse, respectively.
